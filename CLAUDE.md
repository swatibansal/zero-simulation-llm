...
about. It is a learning lab on distributed training; the README is the write-up and is written in the author's
first-person voice.
...
- Branch `main` is the published branch. Work on feature branches and squash-merge; keep `main` linear.
